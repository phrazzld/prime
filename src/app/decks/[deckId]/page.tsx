...
//   return (
//     <div>
//       <h1 className="text-2xl mb-4">deck: {deckTitle}</h1>
//
//       <form onSubmit={createCard} className="flex flex-col gap-2 mb-4 max-w-sm">
//         <input
//           type="text"
...
//         {cards.map((card) => (
//           <li key={card.id} className="border p-2">
//             <div className="flex justify-between items-center">
//               <div>
//                 <strong>q:</strong> {card.question_text} <br />
//                 <strong>a:</strong> {card.answer_text}
